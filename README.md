...
Cortex has a 0.9.5 release meaning all libraries are released on [clojars](https://clojars.org/thinktopic/cortex).  This is very preliminary and you should expect quite a few things to change
