...
(deftest build-big-description
  (let [built-network (build/build-network mnist-description-with-toys)
        ...
        inference-mem (->> (traverse/network->inference built-network)
                           realize-traversals)
        inference-none (->> (traverse/network->inference built-network :optimise-type :none)
                            realize-traversals)]
    ...
    (is (= 434280 (->> (get-in built-network [:layer-graph :buffers])
                       ...
                       (reduce +))))
    (is (= [{:id :dropout-1,
             :incoming [{:id :dropout-1-input-0, :input-idx 0}],
             :outgoing :dropout-1}
            ...
            {:id :batch-normalization-1, :incoming [:dropout-3],
             :outgoing :batch-normalization-1}
    ...
    (is (= {:batch-normalization-1 {:size 800},
            :convolutional-1 {:size 11520},
            :convolutional-2 {:size 3200},
            :dropout-1 {:size 784},
            :dropout-1-input-0 {:inputs {0 784}, :size 784},
            :dropout-2 {:size 2880},
            :dropout-3 {:size 800},
            :dropout-4 {:size 500},
            :linear-1 {:size 500},
    ...
    (is (= [{:id :convolutional-1,
             :incoming [{:id :convolutional-1-input-0, :input-idx 0}],
             :outgoing :convolutional-1}
            {:id :max-pooling-1, :incoming [:convolutional-1],
             :outgoing :convolutional-1-input-0}
            {:id :relu-1, :incoming [:convolutional-1-input-0], :outgoing :convolutional-1}
            {:id :convolutional-2,
             :incoming [:convolutional-1],
             :outgoing :convolutional-1-input-0}
            {:id :max-pooling-2, :incoming [:convolutional-1-input-0],
             :outgoing :convolutional-1}
            {:id :relu-2, :incoming [:convolutional-1], :outgoing :convolutional-1-input-0}
            {:id :batch-normalization-1,
             :incoming [:convolutional-1-input-0],
             :outgoing :convolutional-1}
            {:id :linear-1, :incoming [:convolutional-1], :outgoing :convolutional-1-input-0}
            {:id :relu-3, :incoming [:convolutional-1-input-0], :outgoing :convolutional-1}
            {:id :linear-2, :incoming [:convolutional-1], :outgoing :convolutional-1-input-0}
            {:id :softmax-1, :incoming [:convolutional-1-input-0], :outgoing :convolutional-1}]
           (get inference-mem :forward)))
    (is (= {:convolutional-1 {:id :convolutional-1, :size 11520},
            :convolutional-1-input-0 {:id :convolutional-1-input-0, :inputs {0 784}, :size 3200}}
    ...
    (is (= {:batch-normalization-1 {:size 800},
            :convolutional-1 {:size 11520},
            :convolutional-1-input-0 {:inputs {0 784}, :size 784},
            :convolutional-2 {:size 3200},
            :linear-1 {:size 500},
            :linear-2 {:size 10},
            :max-pooling-1 {:size 2880},
