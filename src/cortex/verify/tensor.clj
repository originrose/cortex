...
(defn convolution-operator
  ...
  (tensor-context
   ...
   (let [batch-size 3
     ...
     (ct/convolution-backward-weights! weight-gradient output-gradient input workspace conv-desc algorithms)
     (is (m/equals [42.0, 54.0, 66.0, 90.0, 102.0, 114.0, 138.0, 150.0, 162.0, 42.0,
                    54.0, 66.0, 90.0, 102.0, 114.0, 138.0, 150.0, 162.0, 42.0, 54.0,
                    66.0, 90.0, 102.0, 114.0, 138.0, 150.0, 162.0, 42.0, 54.0, 66.0,
                    90.0, 102.0, 114.0, 138.0, 150.0, 162.0, 42.0, 54.0, 66.0, 90.0,
                    102.0, 114.0, 138.0, 150.0, 162.0, 42.0, 54.0, 66.0, 90.0, 102.0,
                    114.0, 138.0, 150.0, 162.0, 42.0, 54.0, 66.0, 90.0, 102.0, 114.0,
                    138.0, 150.0, 162.0, 42.0, 54.0, 66.0, 90.0, 102.0, 114.0, 138.0,
                    150.0, 162.0, 42.0, 54.0, 66.0, 90.0, 102.0, 114.0, 138.0, 150.0,
                    162.0, 42.0, 54.0, 66.0, 90.0, 102.0, 114.0, 138.0, 150.0, 162.0,
                    42.0, 54.0, 66.0, 90.0, 102.0, 114.0, 138.0, 150.0, 162.0, 42.0,
                    54.0, 66.0, 90.0, 102.0, 114.0, 138.0, 150.0, 162.0]
                   (ct/to-double-array weight-gradient)))

     (ct/convolution-backward-data! input-gradient output-gradient weights workspace conv-desc algorithms)
