...
(defn- setup-optimizer
  ...
  (let [m (math/new-array driver stream datatype [param-count])
...
(defmethod create-optimizer [:cpu :adam :float]
...
(defmethod create-optimizer [:cpu :adam :double]
  [backend optimizer param-count]
