...
(defn train
  "Epoch train filter takes an epoch-index and a train config and produces
a new train config after perhaps printing output or some other side effecty thing."
